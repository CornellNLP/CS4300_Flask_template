...
def get_data(start, end, reviews_file, info_file, json_file):
    dict_of_shows = {}
    ...
    TV_reviews_df.to_csv("datasets/" + reviews_file)
    ...
    TV_info_df.to_csv("datasets/" + info_file)


    a_file = open("datasets/" + json_file, "w")
